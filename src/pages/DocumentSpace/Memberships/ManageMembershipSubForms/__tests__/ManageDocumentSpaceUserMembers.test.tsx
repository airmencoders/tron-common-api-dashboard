...
import ManageDocumentSpaceUserMembers from '../ManageDocumentSpaceUserMembers';

jest.mock('../../../../../state/document-space/document-space-state');

const mockMembers: DocumentSpaceDashboardMemberResponseDto[] = [
  {
    id: 'sdfsdf',
    email: 'sdf@test.mil',
    privileges: [
...
describe('Manage Document Space User Tests', () => {
  ...
  it('should render a list of document space users assigned', async () => {
    ...
    await waitFor(() => expect(page.getByText('sdf@test.mil')).toBeVisible());
    await waitFor(() => expect(page.getByText('sdf2@test.mil')).toBeVisible());
  });
});
